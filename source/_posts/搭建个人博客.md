...
## 购买域名
可以直接在域名服务商处购买域名，域名后缀推荐 .com、.top、.club 等常见后缀。域名和服务器所在地区会影响后续配置流程，部署前最好先确认解析、HTTPS 证书和访问策略。
## 上传一篇博客
...
# 结束
到此为止，一个博客网站就搭建好了。过程中遇到了一些小麻烦，比如 nodejs 的安装有多种方式，域名和 HTTPS 配置也需要留意。后续也考虑加上一键部署、更换主题等能力。
